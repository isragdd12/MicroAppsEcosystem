  ...
  return (
    <Screen>
      <Stack gap={4} style={{ padding: spacing(4) }}>
        ...
        {!petId && (
          <TextInput label="Pet ID *" value={targetPetId} onChangeText={setTargetPetId} placeholder="Paste pet ID or navigate from a pet" />
        )}
        <TextInput label="Food type *" value={foodType} onChangeText={setFoodType} placeholder="e.g. Dry kibble" />
        <TextInput label="Amount (grams)" value={amountGrams} onChangeText={setAmountGrams} placeholder="e.g. 150" keyboardType="decimal-pad" />
        ...
        <Button label={isPending ? 'Saving…' : 'Log feeding'} onPress={handleSave} />
